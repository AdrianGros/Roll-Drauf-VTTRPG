...
FIXED_GUILD_DEFINITIONS = (
    {
        "slug": "sternenwacht",
        "name": "Sternenwacht",
        "tagline": "Haltet den Blick auf das naechste Kapitel.",
        "description": "Die Sternenwacht sammelt Leserinnen und Leiter, die Kampagnen vorausschauen, Session-Pfade schliessen und den Weg zum naechsten Tischmoment offen halten.",
        "accent": "gold",
        "display_order": 10,
    },
    {
        ...
        "description": "Der Bernsteinkreis ordnet Geschichten, Figuren und Kampagnenspuren. Diese Gilde steht fuer Archiv, Orientierung und das ruhige Sammeln von Fortschritt im Buch.",
        "accent": "amber",
        "display_order": 20,
    },
    {
        "slug": "nebellaterne",
        "name": "Nebellaterne",
        "tagline": "Vorhut fuer unbekannte Wege.",
        "description": "Die Nebellaterne ist fuer Aufbruch, Entdeckung und neue Vorbereitungswege gedacht. Hier landen Spielerinnen und DMs, die gern als Erste neue Kapitel betreten.",
        "accent": "mist",
        "display_order": 30,
    },
    {
        ...
        "description": "Der Eichenbund steht fuer stabile Heimathaeuser, eingespielte Runden und das gemeinsame Tragen von Vorbereitung, Session-Klarheit und wiederkehrenden Ritualen.",
        "accent": "forest",
        "display_order": 40,
    },
)
