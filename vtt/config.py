...
class Config:
    ...
    # Discord OAuth2 / Bot-backed login
    DISCORD_LOGIN_ENABLED = _parse_bool(os.getenv("DISCORD_LOGIN_ENABLED"), default=False)
    DISCORD_CLIENT_ID = os.getenv("DISCORD_CLIENT_ID")
    DISCORD_CLIENT_SECRET = os.getenv("DISCORD_CLIENT_SECRET")
    DISCORD_REDIRECT_URI = os.getenv("DISCORD_REDIRECT_URI")
    DISCORD_AUTHORIZATION_BASE_URL = os.getenv(
    ...
    DISCORD_API_BASE_URL = os.getenv(
        "DISCORD_API_BASE_URL",
        "https://discord.com/api/v10",
    )
    DISCORD_OAUTH_SCOPES = _parse_csv(os.getenv("DISCORD_OAUTH_SCOPES"), ("identify", "email"))
    DISCORD_GUILD_ID = os.getenv("DISCORD_GUILD_ID")
    DISCORD_BOT_VERIFICATION_URL = os.getenv("DISCORD_BOT_VERIFICATION_URL")
    DISCORD_BOT_SHARED_SECRET = os.getenv("DISCORD_BOT_SHARED_SECRET")
    DISCORD_REQUEST_TIMEOUT_SECONDS = _parse_float(os.getenv("DISCORD_REQUEST_TIMEOUT_SECONDS"), 10.0)
